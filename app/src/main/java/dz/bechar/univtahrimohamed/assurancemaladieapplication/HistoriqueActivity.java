...
public class HistoriqueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acceuil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(HistoriqueActivity.this, Activity5.class);
            }
        });
        ...
        rembous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(HistoriqueActivity.this, RemboursementActivity.class);
            }
        });
        ...
        profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(HistoriqueActivity.this, ProfileActivity.class);
            }
        });
        ...
        reclamation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(HistoriqueActivity.this, ReclamationActivity.class);
            }
        });
        ...
        telecharge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //redirectActivity(HistoriqueActivity.this, TelechargeActivity.class);
            }
        });
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(HistoriqueActivity.this, NotificationActivity.class);
            }
        });
        ...
        deconnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                System.exit(0);
                Toast.makeText(HistoriqueActivity.this, "Déconnecter", Toast.LENGTH_SHORT).show();
