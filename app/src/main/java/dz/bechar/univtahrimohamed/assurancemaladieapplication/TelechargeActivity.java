...
public class TelechargeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acceuil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(TelechargeActivity.this, Activity5.class);
            }
        });
        ...
        rembous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(TelechargeActivity.this, RemboursementActivity.class);
            }
        });
        ...
        profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(TelechargeActivity.this, ProfileActivity.class);
            }
        });
        ...
        historique.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(TelechargeActivity.this, HistoriqueActivity.class);
            }
        });
        ...
        reclamation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(TelechargeActivity.this, ReclamationActivity.class);
            }
        });
        ...
        notification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(TelechargeActivity.this, NotificationActivity.class);
            }
        });
        ...
        deconnect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(TelechargeActivity.this, "Déconnecter", Toast.LENGTH_SHORT).show();
                System.exit(0);
            }
        });
