...
public class VignetteActivity8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vignette8);
        ...
        datesoin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(VignetteActivity8.this, date, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
    ...
    public void idElements(){
        ordonancebtn = findViewById(R.id.ordonancebtn8);
        ordonanceimage = findViewById(R.id.ordonanceimage8);

        feuilebtn = findViewById(R.id.feuilebtn8);
        feuileimage = findViewById(R.id.feuileimage8);

        datesoin = findViewById(R.id.datesoin8);

        valid = findViewById(R.id.validerbtn8);
