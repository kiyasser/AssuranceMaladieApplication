...
public class OptiqueActivity10 extends AppCompatActivity {

    Button ordonancebtn, feuilebtn;
    ImageView ordonanceimage, feuileimage;
    EditText datesoin;
    private final int GALLERY_REQ_CODE = 1000, GALLERY_REQ_CODE2 = 2000;
    ...
    Uri file1, file2;
    String file1url = null, file2url = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_optique10);
        ...
        datesoin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(OptiqueActivity10.this, date, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
    ...
    public void idElements(){
        ordonancebtn = findViewById(R.id.ordonancebtn10);
        ordonanceimage = findViewById(R.id.ordonanceimage10);

        feuilebtn = findViewById(R.id.feuilebtn10);
        feuileimage = findViewById(R.id.feuileimage10);

        datesoin = findViewById(R.id.datesoin10);

        valid = findViewById(R.id.validerbtn10);
    ...
    public void storeInfo() {
        ...
        if(file1url != null && file2url != null){
            ...
            analyse.put("file3", null);
            analyse.put("type", "optique");
