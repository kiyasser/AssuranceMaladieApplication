...
public class RadiographieActivity9 extends AppCompatActivity {

    Button ordonancebtn, comptrendubtn, feuilebtn;
    ImageView ordonanceimage, comptrenduimage, feuileimage;
    EditText datesoin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_radiographie9);
        ...
        datesoin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(RadiographieActivity9.this, date, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        comptrendubtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent iGalley = new Intent(Intent.ACTION_PICK);
                iGalley.setData(MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode==RESULT_OK){
            ...
            if (requestCode==GALLERY_REQ_CODE2){
                comptrenduimage.setImageURI(data.getData());
                file2 = data.getData();
            }
    ...
    public void idElements(){
        ordonancebtn = findViewById(R.id.ordonancebtn9);
        ordonanceimage = findViewById(R.id.ordonanceimage9);

        comptrendubtn = findViewById(R.id.compterenduebtn9);
        comptrenduimage = findViewById(R.id.comptrenduimage9);

        feuilebtn = findViewById(R.id.feuilebtn9);
        feuileimage = findViewById(R.id.feuileimage9);

        datesoin = findViewById(R.id.datesoin9);

        valid = findViewById(R.id.validerbtn9);
